...
;(function() {
    ...
    ctx.prototype.arcTo = function(x1, y1, x2, y2, radius) {
        ...
        console.log("Function arcTo is not fully supported for SVG drawing. Drawing straight line instead.");
        this.lineTo(x1, y1);
        return;
        /*
        ...
        var vecLen = (v)=>{return Math.sqrt(v[0]*v[0]+v[1]*v[1])};
        var magnitude = (v1,v2)=>{return vecLen(v1)*vecLen(v2)};

        // note that both vectors are unit vectors, so the length is 1
        var cos = (unit_vec_p1_p0[0] * unit_vec_p1_p2[0] + unit_vec_p1_p0[1] * unit_vec_p1_p2[1])
            /magnitude(unit_vec_p1_p0,unit_vec_p1_p2);
        ...
        */
        /*
        console.log("skipping connecting lines...");
