...
describe('column', () => {
    ...
    const numStr = Column.ofArray({ array: [1, 2], schema: Column.Schema.str });
    it('constant', () => {
...
describe('string column', () => {
    ...
    const arr = Column.ofArray({ array: xs, schema: Column.Schema.str });
    const arrLC = Column.ofArray({ array: xs, schema: Column.Schema.Str({ transform: 'lowercase' }) });
    const aliasedLC = Column.ofArray({ array: xs, schema: Column.Schema.Aliased(Column.Schema.lstr) });
    it('value', () => {
        var _a, _b;
