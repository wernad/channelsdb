...
describe('tensor', () => {
    it('vector', () => {
        const V = tensor_1.Tensor.Vector(3);
        const data = V.create();
        V.set(data, 0, 1);
        V.set(data, 1, 2);
        V.set(data, 2, 3);
    ...
    it('matrix cm', () => {
        const M = tensor_1.Tensor.ColumnMajorMatrix(3, 2, Int32Array);
        const data = M.create();
        // rows: [ [0, 1], [1, 2], [2, 3]  ]
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 2; j++) {
    ...
    it('matrix rm', () => {
        const M = tensor_1.Tensor.RowMajorMatrix(3, 2, Int32Array);
        const data = M.create();
        // rows: [ [0, 1], [1, 2], [2, 3]  ]
        for (let i = 0; i < 3; i++) {
            for (let j = 0; j < 2; j++) {
    ...
    it('mat4 equiv', () => {
        const M = tensor_1.Tensor.ColumnMajorMatrix(4, 4);
        const data = M.create();
        const m = (0, mat4_1.Mat4)();
        for (let i = 0; i < 4; i++) {
            for (let j = 0; j < 4; j++) {
                const v = (i + 1) * (j + 2);
                M.set(data, i, j, v);
    ...
    it('2d ij', () => {
        const M = tensor_1.Tensor.Space([3, 4], [0, 1]);
        const data = M.create();
    ...
    it('2d ji', () => {
        const M = tensor_1.Tensor.Space([3, 4], [1, 0]);
        const data = M.create();
        const exp = new Float64Array(3 * 4);
        let o = 0;
        for (let j = 0; j < 4; j++) {
    ...
    it('3d ijk', () => {
        const M = tensor_1.Tensor.Space([3, 4, 5], [0, 1, 2]);
        const data = M.create();
    ...
    it('3d ikj', () => {
        const M = tensor_1.Tensor.Space([3, 3, 3], [0, 2, 1]);
        const data = M.create();
    ...
    it('3d jik', () => {
        const M = tensor_1.Tensor.Space([3, 3, 3], [1, 0, 2]);
        const data = M.create();
        const exp = new Float64Array(3 * 3 * 3);
        let o = 0;
        for (let j = 0; j < 3; j++) {
    ...
    it('3d jki', () => {
        const M = tensor_1.Tensor.Space([3, 3, 3], [1, 2, 0]);
        const data = M.create();
        const exp = new Float64Array(3 * 3 * 3);
        let o = 0;
        for (let j = 0; j < 3; j++) {
    ...
    it('3d kij', () => {
        const M = tensor_1.Tensor.Space([3, 3, 3], [2, 0, 1]);
        const data = M.create();
        const exp = new Float64Array(3 * 3 * 3);
        let o = 0;
        for (let k = 0; k < 3; k++) {
    ...
    it('3d kji', () => {
        const M = tensor_1.Tensor.Space([3, 3, 3], [2, 1, 0]);
        const data = M.create();
        const exp = new Float64Array(3 * 3 * 3);
        let o = 0;
        for (let k = 0; k < 3; k++) {
    ...
    it('4d jikl', () => {
        const M = tensor_1.Tensor.Space([2, 3, 4, 5], [1, 0, 2, 3]);
        const data = M.create();
    ...
    it('4d jilk', () => {
        const M = tensor_1.Tensor.Space([2, 3, 4, 5], [1, 0, 3, 2]);
        const data = M.create();
        const exp = new Float64Array(2 * 3 * 4 * 5);
        let o = 0;
        for (let j = 0; j < 3; j++) {
    ...
    it('indexing', () => {
        ...
        for (let dim = 1; dim <= 5; dim++) {
            ...
            for (const ao of permutations(axes)) {
                const space = tensor_1.Tensor.Space(dims, ao);
