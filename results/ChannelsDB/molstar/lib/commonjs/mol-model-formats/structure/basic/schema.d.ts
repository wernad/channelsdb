...
export declare const BasicSchema: {
    ...
    entity: {
        ...
        type: import("../../../mol-data/db").Column.Schema.Aliased<"water" | "polymer" | "branched" | "non-polymer" | "macrolide">;
    ...
    entity_poly: {
        entity_id: import("../../../mol-data/db").Column.Schema.Str;
        nstd_linkage: import("../../../mol-data/db").Column.Schema.Aliased<"y" | "no" | "n" | "yes">;
        nstd_monomer: import("../../../mol-data/db").Column.Schema.Aliased<"y" | "no" | "n" | "yes">;
    ...
    entity_poly_seq: {
        entity_id: import("../../../mol-data/db").Column.Schema.Str;
        hetero: import("../../../mol-data/db").Column.Schema.Aliased<"y" | "no" | "n" | "yes">;
    ...
    chem_comp: {
        type: import("../../../mol-data/db").Column.Schema.Aliased<"ion" | "saccharide" | "lipid" | "non-polymer" | "other" | "d-peptide linking" | "l-peptide linking" | "d-peptide nh3 amino terminus" | "l-peptide nh3 amino terminus" | "d-peptide cooh carboxy terminus" | "l-peptide cooh carboxy terminus" | "dna linking" | "rna linking" | "l-rna linking" | "l-dna linking" | "dna oh 5 prime terminus" | "rna oh 5 prime terminus" | "dna oh 3 prime terminus" | "rna oh 3 prime terminus" | "d-saccharide, beta linking" | "d-saccharide, alpha linking" | "l-saccharide, beta linking" | "l-saccharide, alpha linking" | "l-saccharide" | "d-saccharide" | "peptide linking" | "peptide-like" | "l-gamma-peptide, c-delta linking" | "d-gamma-peptide, c-delta linking" | "l-beta-peptide, c-gamma linking" | "d-beta-peptide, c-gamma linking">;
        formula: import("../../../mol-data/db").Column.Schema.Str;
        formula_weight: import("../../../mol-data/db").Column.Schema.Float;
        id: import("../../../mol-data/db").Column.Schema.Str;
        mon_nstd_flag: import("../../../mol-data/db").Column.Schema.Aliased<"y" | "no" | "n" | "yes">;
        name: import("../../../mol-data/db").Column.Schema.Str;
    ...
    pdbx_unobs_or_zero_occ_residues: {
        ...
        occupancy_flag: import("../../../mol-data/db").Column.Schema.Aliased<"0" | "1">;
