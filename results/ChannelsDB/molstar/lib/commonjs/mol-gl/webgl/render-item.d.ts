...
export declare function getDrawMode(ctx: WebGLContext, drawMode: DrawMode): 0 | 2 | 3 | 1 | 4 | 5 | 6;
...
export declare const GraphicsRenderVariants: ("color" | "depth" | "marking" | "pick")[];
...
export declare function createGraphicsRenderItem(ctx: WebGLContext, drawMode: DrawMode, shaderCode: ShaderCode, schema: RenderableSchema, values: RenderableValues, materialId: number, transparency: Transparency): RenderItem<"color" | "depth" | "marking" | "pick">;
