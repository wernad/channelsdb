    ...
    Canvas3D: {
        SetSettings: PluginCommand<{
            settings: Partial<import("../mol-util/param-definition").ParamDefinition.Values<{
                ...
                pickPadding: import("../mol-util/param-definition").ParamDefinition.Numeric;
                ...
                hiZ: import("../mol-util/param-definition").ParamDefinition.Group<import("../mol-util/param-definition").ParamDefinition.Normalize<{
                    enabled: boolean;
                    maxFrameLag: number;
                    minLevel: number;
                }>>;
