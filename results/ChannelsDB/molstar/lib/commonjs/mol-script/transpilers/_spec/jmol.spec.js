...
const keywords_1 = require("../jmol/keywords");
const properties_1 = require("../jmol/properties");
const operators_1 = require("../jmol/operators");
const general = {
    supported: [
        // atom expressions
        '123',
...
describe('jmol keywords', () => u.testKeywords(keywords_1.keywords, parser_1.transpiler));
describe('jmol properties', () => u.testProperties(properties_1.properties, parser_1.transpiler));
describe('jmol operators', () => u.testOperators(operators_1.operators, parser_1.transpiler));
