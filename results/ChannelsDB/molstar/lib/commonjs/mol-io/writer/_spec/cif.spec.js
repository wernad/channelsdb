...
const Data = tslib_1.__importStar(require("../../reader/cif/data-model"));
const cif_1 = require("../cif");
const decode_1 = require("../../common/msgpack/decode");
const field_1 = require("../../reader/cif/binary/field");
const text_1 = require("../cif/encoder/text");
const C = tslib_1.__importStar(require("../cif/encoder"));
const db_1 = require("../../../mol-data/db");
const parser_1 = require("../../reader/cif/text/parser");
...
const encoding_aware_encoder = cif_1.CifWriter.createEncoder({
    binary: true,
...
test('cif writer value escaping', async () => {
    ...
    const table = db_1.Table.ofArrays({ values: db_1.Column.Schema.str }, { values });
    const encoder = new text_1.TextEncoder();
    ...
    const parsed = (_a = cat.getField('values')) === null || _a === void 0 ? void 0 : _a.toStringArray();
...
const filter_aware_encoder1 = cif_1.CifWriter.createEncoder({
    binary: true,
    binaryAutoClassifyEncoding: true
});
filter_aware_encoder1.setFilter(C.Category.filterOf('atom_site\n' +
    ...
    'atom_site.Cartn_x\n' +
    'atom_site.Cartn_y\n'));
const filter_aware_encoder2 = cif_1.CifWriter.createEncoder({
    binary: true
});
...
function process(encoder) {
    ...
    const encoded = encoder.getData();
    const unpacked = (0, decode_1.decodeMsgPack)(encoded);
...
function getCategoryInstanceProvider(cat, fields) {
    return {
        name: cat.name,
        instance: () => cif_1.CifWriter.categoryInstance(fields, { data: cat, rowCount: cat.rowCount })
    };
}
function wrap(name, field) {
    ...
    if (type['@type'] === 'str') {
        ...
        return { name, type: 2 /* CifWriter.Field.Type.Float */, value: field.float, valueKind: field.valueKind };
    }
    else {
        return { name, type: 1 /* CifWriter.Field.Type.Int */, value: field.int, valueKind: field.valueKind };
    }
}
