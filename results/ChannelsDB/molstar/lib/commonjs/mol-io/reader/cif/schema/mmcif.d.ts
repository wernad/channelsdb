...
export declare const mmCIF_Schema: {
    ...
    chem_comp: {
         ...
         */
        mon_nstd_flag: Schema.Aliased<"y" | "no" | "n" | "yes">;
        /**
    ...
    database_2: {
         ...
         */
        database_id: Schema.Aliased<"rcsb" | "pdbe" | "pdb" | "alphafolddb" | "cas" | "csd" | "emdb" | "icsd" | "modelarchive" | "mdf" | "modbase" | "ndb" | "nbs" | "pdf" | "swiss-model_repository" | "ebi" | "bmrb" | "wwpdb" | "pdb_acc">;
        /**
    ...
    entity_poly: {
         ...
         * _entity_poly.type.
         */
        nstd_linkage: Schema.Aliased<"y" | "no" | "n" | "yes">;
        /**
         * A flag to indicate whether the polymer contains at least
         * one monomer that is not considered standard.
         */
        nstd_monomer: Schema.Aliased<"y" | "no" | "n" | "yes">;
        /**
    ...
    entity_poly_seq: {
         ...
         */
        hetero: Schema.Aliased<"y" | "no" | "n" | "yes">;
        /**
         * This data item is a pointer to _chem_comp.id in the CHEM_COMP
         * category.
         */
