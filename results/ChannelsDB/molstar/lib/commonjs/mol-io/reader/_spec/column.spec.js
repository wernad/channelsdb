...
describe('fixed text column', () => {
    const col = (0, fixed_1.FixedColumnProvider)({ data: linesData, indices: linesTokens, count: lines.length });
    const col1 = col(0, 5, db_1.Column.Schema.float);
    const col2 = col(5, 4, db_1.Column.Schema.str);
    it('number', () => {
...
describe('token text column', () => {
    ...
    const col = (0, token_1.TokenColumnProvider)({ data: tokensData, indices: [0, 1, 1, 2, 2, 3], count: 3 });
    const col1 = col(db_1.Column.Schema.int);
    it('number', () => {
...
describe('binary column', () => {
    it('window works', () => {
        ...
        const w1 = db_1.ColumnHelpers.typedArrayWindow(xs, { start: 1 });
        const w2 = db_1.ColumnHelpers.typedArrayWindow(xs, { start: 2, end: 4 });
