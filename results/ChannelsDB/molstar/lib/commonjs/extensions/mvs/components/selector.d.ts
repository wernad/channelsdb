...
export declare const StaticSelectorChoice: Choice<"all" | "water" | "ion" | "protein" | "polymer" | "nucleic" | "lipid" | "branched" | "ligand" | "non-standard" | "coarse", "all">;
...
export declare const SelectorParams: PD.Mapped<PD.NamedParams<import("../../../mol-script/script").Script, "script"> | PD.NamedParams<"all" | "water" | "ion" | "protein" | "polymer" | "nucleic" | "lipid" | "branched" | "ligand" | "non-standard" | "coarse", "static"> | PD.NamedParams<Expression, "expression"> | PD.NamedParams<StructureElement.Bundle, "bundle"> | PD.NamedParams<PD.Normalize<{
    fieldName: string;
    annotationId: string;
