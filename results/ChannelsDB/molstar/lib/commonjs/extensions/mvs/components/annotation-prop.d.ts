...
export declare const MVSAnnotationsParams: {
    annotations: PD.ObjectList<PD.Normalize<{
        ...
        schema: "residue" | "chain" | "entity" | "atom" | "whole_structure" | "auth_chain" | "auth_residue" | "residue_range" | "auth_residue_range" | "auth_atom" | "all_atomic";
        cifBlock: PD.NamedParams<PD.Normalize<{
            index: any;
        }>, "index"> | PD.NamedParams<PD.Normalize<{
            header: any;
        }>, "header">;
