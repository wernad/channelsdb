...
export declare const MVSAnnotationSchema: Choice<"residue" | "chain" | "entity" | "atom" | "whole_structure" | "auth_chain" | "auth_residue" | "residue_range" | "auth_residue_range" | "auth_atom" | "all_atomic", "all_atomic">;
...
declare const FieldsForSchemas: {
    ...
    chain: ("label_entity_id" | "label_asym_id" | "group_id")[];
    auth_chain: ("auth_asym_id" | "group_id")[];
    residue: ("label_entity_id" | "label_asym_id" | "label_seq_id" | "group_id")[];
    auth_residue: ("auth_asym_id" | "auth_seq_id" | "pdbx_PDB_ins_code" | "group_id")[];
    residue_range: ("label_entity_id" | "label_asym_id" | "beg_label_seq_id" | "end_label_seq_id" | "group_id")[];
    auth_residue_range: ("auth_asym_id" | "beg_auth_seq_id" | "end_auth_seq_id" | "group_id")[];
    atom: ("label_entity_id" | "label_asym_id" | "label_seq_id" | "type_symbol" | "label_atom_id" | "atom_id" | "atom_index" | "group_id")[];
    auth_atom: ("auth_asym_id" | "auth_seq_id" | "pdbx_PDB_ins_code" | "type_symbol" | "auth_atom_id" | "atom_id" | "atom_index" | "group_id")[];
    all_atomic: ("auth_asym_id" | "auth_seq_id" | "pdbx_PDB_ins_code" | "label_entity_id" | "label_asym_id" | "label_seq_id" | "type_symbol" | "label_atom_id" | "auth_atom_id" | "atom_id" | "beg_label_seq_id" | "end_label_seq_id" | "beg_auth_seq_id" | "end_auth_seq_id" | "atom_index" | "group_id")[];
};
export {};
