...
const sorted_ranges_1 = require("../sorted-ranges");
...
describe('rangesArray', () => {
    ...
    function testIterator(name, ranges, set, expectedValues) {
        it(`iterator, ${name}`, () => {
            const rangesIt = sorted_ranges_1.SortedRanges.transientSegments(ranges, set);
    ...
    const a1234 = sorted_ranges_1.SortedRanges.ofSortedRanges([1, 2, 3, 4]);
    const a1134 = sorted_ranges_1.SortedRanges.ofSortedRanges([1, 1, 3, 4]);
