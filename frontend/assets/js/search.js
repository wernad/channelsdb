            ...
            return React.createElement("div", { style: { margin: '60px 0 0 20px' } },
                ...
                React.createElement("div", { className: 'row' },
                    React.createElement("div", { className: 'col-md-7' },
                        ...
                        React.createElement("p", { style: justify }, "In the database a channel is represented by its centerline and a radius towards the closest protein atom. Channel profile is decomposed into discrete regions called layers. Each layer is defined by the residues lining it. A new layer starts whenever there is a change in residues lining it along its length. These size and composition of these layers is in turn used for estimating channel's physicochemical properties.")),
                    React.createElement("div", { className: 'col-md-5' },
