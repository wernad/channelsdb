                ...
                React.createElement("div", { className: 'row featurette' },
                    ...
                    React.createElement("div", { className: 'col-md-7 col-md-push-5' },
                        ...
                        React.createElement("p", { style: justify },
                            "Cytochrome  P450  2D6  contributes  significantly  to  the  metabolism  of  >15%  of  the  200  most marketed drugs. Cytochrome P450 2D6 structure shows a second molecule of thioridazine bound in an expanded substrate access channel (channel  2a according to ",
            ...
            return React.createElement("div", { style: { margin: '60px 0 0 20px' } },
                ...
                React.createElement("div", { className: 'row' },
                    React.createElement("div", { className: 'col-md-7' },
                        ...
                        React.createElement("p", { style: justify }, "In the database a channel is represented by its centerline and a radius towards the closest protein atom. Channel profile is decomposed into discrete regions called layers. Each layer is defined by the residues lining it. A new layer starts whenever there is a change in residues lining it along its length. Their size and composition is in turn used for estimating channel's physicochemical properties.")),
                    React.createElement("div", { className: 'col-md-5' },
        ...
        Documentation.prototype.render = function () {
            ...
            return React.createElement("div", { style: { margin: '60px 0 0 20px' } },
                ...
                React.createElement("div", { className: 'row' },
                    ...
                    React.createElement("p", { style: justify }, "Throughout the ChannelsDB the folowing settings of the MOLE algorithm has been used for the CSA and cofactor tunnels. For reviewed channels, each calculation has been independently adjusted, in order to extract deemed channel."),
                        ...
                        React.createElement("table", { className: 'table table-condensed active' },
                            ...
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", null,
                                    ...
                                    React.createElement("td", { "data-toggle": 'tooltip', title: 'HetResidues().Filter(lambda m: m.IsNotConnectedTo(AminoAcids()))' }, "Query"))))),
                        ...
                        React.createElement("table", { className: 'table table-condensed active' },
                            ...
                            React.createElement("tbody", null,
                                ...
                                React.createElement("tr", null,
                                    React.createElement("td", null,
                                        React.createElement("i", null, "NonActiveParts")),
                                    React.createElement("td", { "data-toggle": 'tooltip', title: 'Various queries e.g. Atoms("Fe").Inside(Residues("HEM", "HEC", "HEA"))' }, "Query")))))),
                React.createElement("hr", { className: 'featurette-divider', style: { margin: '50px 0' } }),
                React.createElement("div", { className: 'row' },
                    React.createElement("h2", { className: 'featurette-heading' }, "Cofactors list"),
                    React.createElement("p", null, "Following well-known cofactors, which are often burried within a protein structure have been selected for channel prediction. "),
                    React.createElement("div", { className: 'row table-responsive col-md-8 col-md-offset-2' },
                        React.createElement("table", { className: 'table table-condensed active' },
                            React.createElement("thead", null,
                                React.createElement("tr", null,
                ...
                React.createElement("div", { className: 'row featurette' },
                    ...
                    React.createElement("div", { className: 'col-md-5' },
                        ...
                        React.createElement("ol", null,
                            ...
                            React.createElement("li", null, "Directly below the visualization pane you can find an interactive visualization of a channel profile. All the physicochemical properties are mapped on the channel profile. User can select deemed type of property to visualize, change the radius being mesured to the closest atom or to the backbone. ON the top of that to a publication quality image is available for export as well."),
                            ...
                            React.createElement("li", null, " Protein annotatios from the UniProt resource."))),
                    React.createElement("div", { className: 'col-md-7' },
