...
class EditableTable<T extends { [key: string]: any }> extends React.Component<TableSpec<T> & { updated: () => void }, { entries: Array<Entry<T>> }> {
    state = { entries: [] };
    ...
    render() {
        const spec = this.props.spec;
        const cols = Object.keys(spec) as Array<keyof T & string>;
