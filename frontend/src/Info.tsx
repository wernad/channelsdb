        ...
        return <div style={{ marginTop: '0px' }}>
            ...
            <div className='row featurette' style={{ marginTop: '40px' }}>
                ...
                <div className='col-md-7'>
                    <a href='/detail?pid=1ymg'><h2 className='featurette-heading'>Aquaporin O <span className='text-muted'>(1ymg)</span></h2></a>
            ...
            <div className='row featurette'>
                ...
                <div className='col-md-7 col-md-push-5'>
                    <a href='/detail?pid=3tbg'><h2 className='featurette-heading'>Cytochrome P450 2D6 experimental <br />structures<span className='text-muted'>(3tbg)</span></h2></a>
            ...
            <div className='row featurette'>
                ...
                <div className='col-md-7 '>
                    <a href='/detail?pid=P10635'><h2 className='featurette-heading'>Cytochrome P450 2D6 AlphaFill models<span className='text-muted'>(P10635)</span></h2></a>
            ...
            <div className='row featurette'>
                ...
                <div className='col-md-7 '>
                    <a href='/detail?pid=1jj2'><h2 className='featurette-heading'>Large Ribosomal Subunit <span className='text-muted'>(1jj2)</span></h2></a>
            ...
            <div className='row featurette'>
                ...
                <div className='col-md-7 col-md-push-5'>
                    <a href='/detail?pid=4nm9'><h2 className='featurette-heading'>PutA channeling system <span className='text-muted'>(4nm9)</span></h2></a>
            ...
            <div className='row featurette'>
                ...
                <div className='col-md-7 '>
                    <h2 className='featurette-heading'><a href='/detail?pid=5lka'>Haloalkane dehalogenase LinB engineered tunnels </a><span className='text-muted'>(<a href='/detail?pid=1k63'>1k63</a>, <a href='/detail?pid=4wdq'>4wdq</a>, <a href='/detail?pid=5lka'>5lka</a>)</span></h2>
